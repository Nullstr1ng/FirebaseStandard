namespace FirebaseStandard.Database.Query
{
    using System;
    ...
    using FirebaseStandard.Database.Http;
    using FirebaseStandard.Database.Offline;
    using FirebaseStandard.Database.Streaming;
